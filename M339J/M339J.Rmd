...
Basics of `R`. `R` scripts and `R` notebooks. `For` loops.<br>
...
Focus on the expectation <span style="color: purple;">**(Section 3.1.1)**</span>. TVaR <span style="color: purple;">**(Section 10.3.3)**</span>.<br>
