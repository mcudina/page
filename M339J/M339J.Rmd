...
More on the per-payment and per-loss random variables. The limited loss random variable. Loss-modifications demonstration. Franchise deductibles <span style="color: purple;">**(Sections 3.4.1)**</span>.
...
Loss elimination ratio <span style="color: purple;">**(Section 3.4.1)**</span>. Other loss modifications (combined) <span style="color: purple;">**(Section 3.4.2, 3.4.3)**</span>.<br>
