...
#just for laughs
hist(s.T, prob=TRUE, ylim=c(0,0.02))
curve(dlnorm(x, meanlog=log(s0)+(r-sigma^2/2)*T, sdlog=sigma*sqrt(T)), add=TRUE, col="red")
```
...
s.T=s0*rlnorm(nsims, meanlog=mu*T, sdlog=sigma*sqrt(T))
#hist(s.T)
