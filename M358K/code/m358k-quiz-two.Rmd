...
## Problem 7. **(3 points)** 
Set the vector `v` to be the integers between -2 and 4 (inclusive); set the vector `w` to be the first 7 natural numbers; what do you get when you multiply `v` by `w`?
```{r}
