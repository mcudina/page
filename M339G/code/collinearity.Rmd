...
x.1=runif(100)
x.2=alpha.1*x.1+rnorm(100, mean=0, sd=0.01)
x.3=gamma.0*x.1+gamma.1*x.2+rnorm(100, mean=0, sd=0.01)
...
We would also wish to reduce the dimension of the array of predictors by getting read of linear dependence (as much as is feasible).  