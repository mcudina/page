...
The data set we are going to use exists in the `Stat2Data` package. You only need to install it once. Here is the command line for reference. 
...
#Confusion Matrix Below
tab.tr=table(glm.pred.v,Acceptance[train])
tab.tr
