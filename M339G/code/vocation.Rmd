...
summary(mn.fit)
```
Importantly, the coefficients above are **different** from the coefficients one sees in our slides. However, let us look at the fitted probabilities for our data set. 
