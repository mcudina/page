...
The support vectors are plotted as crosses and the remaining observations are plotted as circles; we see here that there are three support vectors. We can determine their identities as follows:
...
This tells us, for instance, that a linear kernel was used with `cost = 10`, and that there were three support vectors, two in one class and one in the other.
