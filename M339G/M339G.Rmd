...
Resampling Methods (Sampling Distribution and Univariate Bootstrap) <span style="color: purple;">**(Section 5.2 and 5.3.4)**</span>.<br>

[Class notes](notes/m339g-jan-19-2024.pdf)

[Wikipedia](https://en.wikipedia.org/wiki/Shapiro–Wilk_test): The Shapiro-Wilk test

[Slides by Hastie & Tibshirani](slides/ch5-univariate-bootstrap.pdf)
...
Resampling Methods (Bootstrap, cont’d).<br>
...
Resampling Methods (Sampling Distribution of the Slope Coefficient).<br>
