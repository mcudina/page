...
[Introduction to Statistical Learning](https://www.statlearning.com) - **our textbook** 
...
[Project Instructions](instructions/m358k-hw-instructions.html) -- if in doubt, read and understand all of this before you work on your project
...
[First-Day Handout](syllabus/syllabus-59080.html)

[The Whole Game](slides/intro.pdf)

---

**Class 2: August 26th, 2026**<br>
A Tiny Review from Mathematical Statistics.<br> 

[In-Class Work #1](problem-sets/m339g-ic1-math-stats-probs.pdf)- **skeleton**

<!--
[Class notes](notes/m339g-jan-14-2026.pdf)
-->

[In-Class Work #1](problem-sets/m339g-ic1-math-stats-full.pdf)
- **complete**

---

**Class 3: August 28th, 2026**<br>
Confidence intervals [review]. Resampling Methods (Sampling Distribution and Univariate Bootstrap) <span style="color: purple;">**(Sections 5.2 and 5.3.4)**</span>.<br>

[Class notes](notes/m339g-aug-28-2026.pdf)
...
[`R`-notebook from class](code/arsenic-empty.Rmd): Arsenic (prompts only)

[`R`-notebook from class](code/arsenic-in-class.Rmd): Arsenic (complete)

[Homework #1](hw/m339g-hw1-prereqs.pdf) -- **due on Friday, September 4th, 2026**
...
[Class notes](notes/m339g-jan-21-2026.pdf)
...
[Project #1](projects/m339g-project1-probs.html) -- **due on Monday, September 21st, 2026**
...
[Class notes](notes/m339g-jan-28-2026.pdf)
...
[Homework #2](hw/m339g-hw2-bootstrap-probs.pdf) -- **due on Friday, September 11th, 2026**
...
[Class notes](notes/m339g-sept-09-2026.pdf)
...
[Class notes](notes/m339g-feb-04-2026.pdf)

[Homework #3](hw/m339g-hw3-regression-probs.pdf) -- **due on Friday, September 18th, 2026**
...
[Class notes](notes/m339g-nov-17-2025.pdf): Lines. Hyperplanes. 

[In-Class Work #2](problem-sets/m339g-ic2-lines-planes-hyperplanes-probs.pdf) -- **skeleton**

[In-Class Work #2](problem-sets/m339g-ic2-lines-planes-hyperplanes-solns.pdf) -- **complete**
...
[Class notes](notes/m339g-sept-18-2026.pdf): MLR. 
...
[Homework #4](hw/m339g-hw4-slr-probs.pdf) -- **due on Friday, September 25th, 2026**
...
[Class notes](notes/m339g-sept-21-2026.pdf): MLR with interactions. 
...
[In-Class Work #3](problem-sets/m339g-ic3-F-distn-probs.pdf) -- **skeleton**

[In-Class Work #3](problem-sets/m339g-ic3-F-distn-solns.pdf) -- **complete**

[My old class notes from *Math Stats*](notes/m378k-mar-07-2025.pdf): Sample variance. 

[Proof of Theorem from class](https://math.stackexchange.com/questions/47009/proof-of-fracn-1s2-sigma2-sim-chi2-n-1)
...
[Homework #5](hw/m339g-hw5-F-probs.pdf) -- **due on Friday, October 2nd, 2026**
...
[Class notes](notes/m339g-sept-25-2026.pdf)
...
**Class 16: September 30th, 2026**<br>
Introduction to Classification.<br>

<!--
[Class notes](notes/m339g-feb-18-2026.pdf)
-->

---

**Class 17: October 2nd, 2026**<br>
...
[Class notes](notes/m339g-feb-20-2026.pdf)

[Homework #4](hw/m339g-hw4-F-solns.pdf) -- **solutions**

---

[Mauna Loa data](projects/mauna-loa.csv)

[Project #2](projects/m339g-project2-probs.html) -- **due on Monday, March 9th, 2026**
...
More on logistic-regression.<br>
...
Even more on logistic regression.<br>
...
[Homework #5](hw/m339g-hw5-logistic-probs.pdf) -- **for practice, not to be handed in**

[Homework #5](hw/m339g-hw5-logistic-solns.pdf) -- **solutions**

[Class notes](notes/m339g-feb-25-2026.pdf)

[Data for class](code/hsbdemo.csv): School choice

[`R`-notebook for class](code/vocation.Rmd): Multiclass logistic regression 

[Homework #6](hw/m339g-hw6-sample-one-probs.pdf) -- **for practice; not to be handed in**
...
**Class 21: March 2nd, 2025**<br>
KNN practice.<br>

[In-Class Work #2](problem-sets/m339g-ic2-knn-probs.pdf) - **skeleton**

[Class notes](notes/m339g-mar-02-2026.pdf)

[In-Class Work #2](problem-sets/m339g-ic2-knn-solns.pdf)
- **complete**
...
[Homework #7](hw/m339g-hw7-k-means.pdf) -- **due on Friday, March 13th, 2026**
...
[Extra-Credit Homework](hw/m339g-ec-hw-svd.pdf) -- **due on Friday, April 17th, 2026**
...
[Class notes](notes/m339g-mar-13-2026.pdf)
...
[Class notes](notes/m339g-mar-23-2026.pdf)

---

**Class 28: March 25th, 2026**<br>
Even more on LDA. The bivariate normal distribution.<br> 

[Class notes](notes/m339g-mar-25-2026.pdf)


---

**Class 29: March 27th, 2026**<br>
The bivariate normal distribution [cont'd].<br> 

[Class notes](notes/m339g-mar-27-2026.pdf)
...
The bivariate normal distribution [practice].<br>

[In-Class Work #3](problem-sets/m339g-ic3-bivariate-normal-probs.pdf) - **problems we will work on in class**

[Class notes](notes/m339g-mar-30-2026.pdf)

[In-Class Work #3](problem-sets/m339g-ic3-bivariate-normal-solns.pdf) - **solution**

[Homework #8](hw/m339g-hw8-lda-qda.pdf) -- **due on Friday, April 3rd, 2026**

[Project #3](projects/m339g-project3-probs.pdf) -- **due on Monday, April 27th, 2026**
...
Multivariate normal distributions.<br>

[Class notes](notes/m339g-apr-01-2026.pdf)
...
**Class 32: April 3rd, 2025**<br>
Even more on the linear discriminant analysis, quadratic discriminant analysis, naive Bayes <span style="color: purple;">**(Section 4.4.1)**</span>.<br>
...
[Homework #9](hw/m339g-hw9-reg-trees.pdf) -- **due on Friday, April 10th, 2026**
...
[Class notes](notes/m339g-apr-08-2026.pdf): Pruning.
...
Classification trees [practice].<br>

[Class notes](notes/m339g-apr-04-2025.pdf): Classification trees.

[Class notes](notes/m339g-apr-07-2025.pdf): More on classification trees.

[Homework #10](hw/m339g-hw10-class-trees.pdf) -- **due on Friday, April 24th, 2026**
...
[Class notes](notes/m339g-nov-12-2025.pdf): 0.632
...
[Homework #11](hw/m339g-hw11-more-trees.pdf) -- **practice for the final exam; not to be handed in**
...
[The Final Project](projects/m339g-final-project-probs.pdf) -- **due on Thursday, December 11th, 2025**
...
[Class notes](notes/m339g-nov-21-2025.pdf): Hyperplanes. Lagrange multipliers.
...
[In-Class Work #4](problem-sets/m339g-ic4-last-day-probs.pdf) - **problems we will work on in class**

[In-Class Work #4](problem-sets/m339g-ic4-last-day-solns.pdf) - **solutions**
